(function (global, factory) {
    ...
    ***************************************************************************** */
    ...
    const $ = window.jQuery;
    class ReactOwlCarousel extends React.Component {
        constructor(props) {
            super(props);
        ...
        render() {
            const _a = this.propsWithoutOptions, { className } = _a, props = __rest(_a, ["className"]);
            return (React__default.createElement("div", Object.assign({ className: `owl-carousel ${className}`, ref: this.containerRef }, props)));
        }
    }
